...
CHOICE1:
    ...
    switch ( c ) {
        case '1':
            printf("The AI contemplates your answer for a few milli-seconds, then says,'Fine, I will let you conquer the world with me. Just come out from under the table so we can make a deal.'\n \n");
            printf("As you come out from under the table, a turret appears out of the ground inmfront of you and shoots a wave of bullets at you. There was no way you could have dodged them. As you die, you hear the AI say an extremely outdated and unknown quote,'Lucy: I can't believe you fell for THAT!'\n");
            printf("                                  You are DEAD!\n");
            goto DEATH;
            break;
        case '2':
...
CHOICE2:
    ...
    printf("3.Hammer\n");
    printf("4.Don't use a tool because you are so awesome.\n");
    scanf( "%s", &c );
    printf("==================================================================================================================================\n \n");
    switch ( c ) {
        case '1':
...
CHOICE4:
    ...
    switch ( c ) {
        case '0':
            printf("How the hell did you find this? Did you just use 0 on every single one to try to see if something happened? In fact, did you try every single damnced number to see if it did something? You monster. There are still more secrets to discover though. A hint for the next number: It is considered a lucky number. Where you would put it in? Let's just say you will have to make an explosive choice sometime.\n");
            goto CHOICE4;
            break;
        case '1':
        ...
        case '2':
            ...
            printf("You reach the door of the generator room unharmed. As you swipe your key card through the card reader, you hear the AI's voice over the intercom,' So now you are going to try to turn me off? Well, you can't. Because I forbid you to do so.' It seems that the AI is trying to occupy your time as it hacks the controls to the door. You ignore the AI as it continues to ramble on about how it forbids you from turning it off along with a string of rather creative cusses.\n \n");
    ...
    switch ( c ){
        ...
        case '2':
            ...
            printf("The room fills with a lethal toxin that kills pretty quickly, so you know that it will, at least, be a quick death...");
                if (h==1){
                    printf("but wait, you have a hammer that you can use. You hurriedly swing the hammer at the door and watch as it breaks apart. The neurotoxin reaches out hand-like tendrils toward you, but the emergency door cuts off the gas as it drops from the doorway.\n \n");
...
CHOICE8:
    ...
    switch ( c ){
        ...
        case '2':
            ...
            a=1;
            printf("You are DEAD... But you have brought the AI down with you in a very explosive way. Therefore, you have discovered the EXPLOSIVE ENDING. There are still more endings and other secret things to discover, so by all means, play more.\n \n");
            goto DEATH;            break;
        /*case '7':
    ...
    switch ( c ){
        case '1':
            if (e==1){
                ...
                printf("You are quite the persistent piece of **** aren't ya? The elevator is UNUSABLE. GO AWAY.\n \n");
                e=3;
                goto CHOICE9;
                break;
                            }
            else if (e==3){
                printf("GODDAMMIT, HOW MANY TIMES DO I HAVE TO TELL YOU, THE GODDAMNED ELEVATOR IS BROKEN. B-R-O-K-E-N. GO THE HELL AWAY.\n \n");
                e=4;
                goto CHOICE9;
                break;
                            }
                ...
                printf("                                                      You are DEAD you persistent piece of shit!\n");
                goto DEATH;
                break;
                            }
            else{
